...
Процедура ОткрытьВыбранныйФайл()
	...
	РаботаСБиблиотекойФайловКлиент.ОткрытьФайл(АдресВременногоХранилища, Элементы.СписокФайлов.ТекущиеДанные.Расширение, 
		Элементы.СписокФайлов.ТекущиеДанные.Файл, Элементы.СписокФайлов.ТекущиеДанные.Размер);
