...
Процедура АдресОтветаОчистка(Элемент, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	АктуализироватьАдресОтветаВХранимомСписоке(АдресОтвета, Ложь);
...
Функция СохранитьАдресОтвета(знач АдресОтвета)
	...
	АктуализироватьАдресОтветаВХранимомСписоке(АдресОтвета);
...
//
&НаСервереБезКонтекста
Функция АктуализироватьАдресОтветаВХранимомСписоке(знач АдресОтвета,
