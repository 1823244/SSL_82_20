...
Функция ПечатьСогласияНаОбработкуПДн(Субъекты, ОбъектыПечати) Экспорт
	...
	Макет = УправлениеПечатью.ПолучитьМакет("Обработка.СогласиеНаОбработкуПерсональныхДанных.ПФ_MXL_СогласиеНаОбработкуПерсональныхДанных");
...
КонецФункции // ПечатьСогласияНаОбработкуПДн
...
КонецФункции // ПечатьСогласияНаОбработкуПДнСубъекта
...
Функция ПолучитьДанныеПечати(знач Субъекты, знач МассивИменМакетов) Экспорт
	...
	Для Каждого ИмяМакета Из МассивИменМакетов Цикл
		Если ИмяМакета = "СогласиеНаОбработкуПерсональныхДанных(MSWord)" Тогда
			ДвоичныеДанныеМакетов.Вставить(ИмяМакета, УправлениеПечатью.ПолучитьМакет("Обработка.СогласиеНаОбработкуПерсональныхДанных.ПФ_DOC_СогласиеНаОбработкуПерсональныхДанных"));
			ТипыМакетов.Вставить(ИмяМакета, "DOC");
		ИначеЕсли ИмяМакета = "СогласиеНаОбработкуПерсональныхДанных(ODT)" Тогда
			ДвоичныеДанныеМакетов.Вставить(ИмяМакета, УправлениеПечатью.ПолучитьМакет("Обработка.СогласиеНаОбработкуПерсональныхДанных.ПФ_ODT_СогласиеНаОбработкуПерсональныхДанных"));
...
КонецФункции // ПолучитьОписаниеОбластейМакетаОфисногоДокумента
