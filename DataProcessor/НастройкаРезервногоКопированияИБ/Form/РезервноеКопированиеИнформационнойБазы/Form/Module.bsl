...
Процедура ОбработатьНачальнуюНастройкуПомощника()
	...
	РезервноеКопированиеИБСервер.ОстановитьАвтоматическоеРезервноеКопирование(, ПараметрыРезервногоКопированияИБ);
	КодПереключателя = Объект.КодТипаРезервногоКопирования;
	РезервноеКопированиеИБСервер.УстановитьКодВыбора(КодПереключателя, ПараметрыРезервногоКопированияИБ);
	...
	ИначеЕсли КодПереключателя = 2 Тогда // Копирование сторонними средствами.
		...
		РезервноеКопированиеИБСервер.ОстановитьСервисОповещения(ПараметрыРезервногоКопированияИБ);
...
Процедура ПриПереходеНаАвтоматическийРежимКопирования()
	...
	Если ПроверитьЗаполнение() Тогда
		...
		Если Объект.ВариантПроведенияРезервногоКопирования = 1 Тогда	
			...
			РезервноеКопированиеИБСервер.УстановитьДатуСледующегоАвтоматическогоКопирования(Истина, ПараметрыРезервногоКопированияИБ);
		Иначе
			ОповещатьОРезервномКопированииПриЗавершенииСеанса = Истина;
			РезервноеКопированиеИБСервер.ОстановитьАвтоматическоеРезервноеКопирование(Истина, ПараметрыРезервногоКопированияИБ);
		КонецЕсли;	
