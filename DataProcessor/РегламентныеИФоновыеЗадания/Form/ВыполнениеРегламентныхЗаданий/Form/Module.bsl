...
Функция ВыполнитьРегламентныеЗаданияСервер(ПараметрЗапуска)
	...
	Результат.Вставить(
		...
		ИЛИ РегламентныеЗаданияСервер.РодительскийСеансЗаданИЗавершен(ПараметрЗапуска)
		ИЛИ НЕ РегламентныеЗаданияСервер.ТекущийСеансВыполняетРегламентныеЗадания() );
...
Процедура ОбновитьТаблицуРегламентныхЗаданий()
	...
	Для Каждого Задание Из ТекущиеЗадания Цикл
		...
		СтрокаЗадания.РегламентноеЗадание
			= РегламентныеЗаданияСервер.ПредставлениеРегламентногоЗадания(Задание);
