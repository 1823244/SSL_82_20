...
Процедура ОбновитьНастройкиОбменаДанными(Отказ,
	...
	Попытка
		...
		УстановитьЗначенияПоУмолчаниюНаУзле(УзелИнформационнойБазыОбъект, ЗначенияПоУмолчаниюНаУзле);
...
Процедура УстановитьЗначенияОтборовНаУзле(УзелПланаОбмена, Настройки)
	
	НастройкаОтборов = ПланыОбмена[ИмяПланаОбмена].НастройкаОтборовНаУзле();
	
	Для Каждого Элемент Из НастройкаОтборов Цикл
		
		Ключ = Элемент.Ключ;
		Значение = Неопределено;
		
		Если Настройки.Свойство(Ключ, Значение) Тогда
...
Процедура УстановитьЗначенияПоУмолчаниюНаУзле(УзелПланаОбмена, Настройки)
	
	НастройкаОтборов = ПланыОбмена[ИмяПланаОбмена].ЗначенияПоУмолчаниюНаУзле();
