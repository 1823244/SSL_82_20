...
Функция ЗаписатьИнформациюОбОшибкеОбработчикиПВД(КодСообщения, СтрокаОшибки, ИмяПравила, Объект = Неопределено, ИмяОбработчика)
...
Процедура ЗагрузитьПравилаОбмена(Источник="", ТипИсточника="XMLФайл") Экспорт
	...
	Если Конвертация.Свойство("ПослеЗагрузкиПравилОбмена", ТекстСобытияПослеЗагрузкиПравилОбмена)
		...
		Исключение
			...
			Текст = НСтр("ru = 'Обработчик: ""ПослеЗагрузкиПравилОбмена"": '") + КраткоеПредставлениеОшибки(ИнформацияОбОшибке()); 
			СообщитьПользователю(Текст);
...
// Открывает форму для формирования файла с обработчиками выгрузки
//
// Параметры:
//  Нет.
// 
...
// Открывает форму для формирования файла с обработчиками выгрузки, когда правила обмена загружаются из макета обработки
//
// Параметры:
//  Нет.
// 
...
// Открывает форму для формирования файла с обработчиками загрузки
//
// Параметры:
//  Нет.
// 
