...
Процедура ОбработчикДействийРезервногоКопирования() Экспорт 
	...
	Если ПараметрыРезервногоКопированияИБНаКлиенте.ОтложенноеРезервноеКопирование Тогда
		ОтложенноеИнтерактивноеРезервноеКопирование(ПараметрыРезервногоКопированияИБНаКлиенте, ПараметрыРезервногоКопированияИБНаКлиенте.КоличествоПользователей);
	КонецЕсли;
...
//	КоличествоПользователей - Число - количество активных пользователей.
//
Процедура ОтложенноеИнтерактивноеРезервноеКопирование(ПараметрыКопирования, КоличествоПользователей) Экспорт
	...
	Если ТекущаяДата > ДатаКопирования Тогда
		ПараметрыРезервногоКопированияИБНаКлиенте = РезервноеКопированиеИБКлиент.ПолучитьПараметрыРезервногоКопированияИБ();   
		РезервноеКопированиеИБСервер.УстановитьЗначениеНастройки("ОтложенноеРезервноеКопирование", Ложь, ПараметрыРезервногоКопированияИБНаКлиенте);
...
// Откывает форму выполнения резервного копирования.
//
