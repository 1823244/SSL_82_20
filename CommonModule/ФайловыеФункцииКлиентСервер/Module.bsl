...
#Если Не ВебКлиент Тогда
	...
	#Иначе	
		СписокРасширенийТекстовыхФайлов = ФайловыеФункцииКлиентПовтИсп.ПолучитьСписокРасширенийТекстовыхФайлов();
	#КонецЕсли
...
#КонецЕсли
	...
	#Если Сервер ИЛИ ВнешнееСоединение Тогда	
		СписокРасширенийФайловOpenDocument = ФайловыеФункцииПовтИсп.ПолучитьСписокРасширенийФайловOpenDocument();
	#Иначе	
		СписокРасширенийФайловOpenDocument = ФайловыеФункцииКлиентПовтИсп.ПолучитьСписокРасширенийФайловOpenDocument();
	#КонецЕсли
