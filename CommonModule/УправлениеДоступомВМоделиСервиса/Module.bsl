...
Процедура УстановитьИспользованиеЗаданияЗаполненияДанных(Знач Использование) Экспорт
	...
	ОтборДляПоиска = Новый Структура("ИмяМетода", "УправлениеДоступом.ЗаполнениеДанныхДляОграниченияДоступаОбработчикЗадания");
...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "УправлениеДоступомВМоделиСервиса.ОбновитьГруппыДоступаАдминистраторовВМоделиСервиса";
