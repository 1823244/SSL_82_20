...
Процедура УстановитьКорневойЭлементДереваАнкеты(ДеревоАнкеты) Экспорт
	...
	НоваяСтрока.КодКартинки  = ПолучитьКодКартинкиШаблонаАнкеты(Ложь);
...
Процедура ДобавитьСтрокиДереваАнкеты(Выборка,СтрокаРодитель,УровеньРекурсии,Форма)
	...
	Пока Выборка.Следующий() Цикл
		...
		НоваяСтрока.КодКартинки          = ПолучитьКодКартинкиШаблонаАнкеты(Выборка.ЭтоРаздел,Выборка.ТипВопроса);
...
////////////////////////////////////////////////////////////////////////////////
// Создание реквизитов формы заполеннеия анкеты
...
Процедура ДобавитьЭлементыВопрос(СтрокаТаблицы,ЭлементГруппа,Форма)
	...
	ЭлементГруппаВопроса.Отображение                = ОтображениеОбычнойГруппы.Отступ;
...
Процедура ДобавитьСтрокиВДеревоРазделов(ВыборкаРазделы,Родитель)
	...
	Пока ВыборкаРазделы.Следующий() Цикл
		...
		НовыйЭлементДерева.КодКартинки        = ПолучитьКодКартинкиШаблонаАнкеты(Истина);
...
Функция ПолучитьКодКартинкиШаблонаАнкеты(ЭтоРаздел,ТипВопроса = Неопределено) Экспорт
	...
	Если ЭтоРаздел Тогда
		Возврат 1;
	ИначеЕсли ТипВопроса = Перечисления.ТипыВопросовШаблонаАнкеты.Простой Тогда
		Возврат 2;
	ИначеЕсли ТипВопроса = Перечисления.ТипыВопросовШаблонаАнкеты.ВопросСУсловием Тогда
		Возврат 4;
	ИначеЕсли ТипВопроса = Перечисления.ТипыВопросовШаблонаАнкеты.Табличный Тогда
		Возврат 3;
	Иначе
		Возврат 0;
	КонецЕсли;
