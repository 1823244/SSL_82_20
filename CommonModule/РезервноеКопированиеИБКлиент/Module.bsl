...
Процедура ПодключитьОжиданиеРезервногоКопирования() Экспорт
	РезервноеКопированиеИБСервер.УстановитьЗначениеНастройки("ОтложенноеРезервноеКопирование", Истина, ПараметрыРезервногоКопированияИБ);
КонецПроцедуры
...
Процедура ПровестиРезервноеКопирование() Экспорт
	...
	РезервноеКопированиеИБСервер.УстановитьДатуСледующегоАвтоматическогоКопирования( , ПараметрыРезервногоКопированияИБ);
...
Процедура ПроверитьРезервноеКопированиеИБ(ПараметрыРезервногоКопирования) Экспорт
	...
	ПараметрыРезервногоКопированияИБ = ЗначениеНастройкиРезервногоКопирования;
...
Процедура ОповеститьПользователяОРезервномКопировании(ВариантОповещения) Экспорт
	...
	ИначеЕсли ВариантОповещения = "Напомнить" Тогда
		...
		НастройкаОповещения = РезервноеКопированиеИБСервер.ПолучитьНастройкиРезервногоКопирования(Истина).ДатаПоследнегоРезервногоКопирования;
	...
	ИначеЕсли ВариантОповещения = "ЕщеНеНастроено" Тогда
		...
		ТекущаяДата = ОбщегоНазначенияКлиент.ДатаСеанса();	
		РезервноеКопированиеИБСервер.УстановитьДатуПоследнегоНапоминания(ТекущаяДата);
	КонецЕсли;	
КонецПроцедуры
...
//
// Возвращаемое значение - Структура - стурктура скрипта резервного копирования.
//
...
// Возвращает параметры резеврного копирования 
