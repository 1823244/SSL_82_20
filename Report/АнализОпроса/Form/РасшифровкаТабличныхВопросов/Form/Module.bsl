...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Отказ = ОбработатьВходящиеПараметры(ФормулировкиЭлементарныхВопросов);
...
Функция ОбработатьВходящиеПараметры(ФормулировкиЭлементарныхВопросов)
	...
	РеквизитыВопросШаблона = ОбщегоНазначения.ПолучитьЗначенияРеквизитов(ВопросШаблонаАнкеты,"ТипТабличногоВопроса,СоставТабличногоВопроса,ПредопределенныеОтветы,Формулировка");
	...
	Заголовок = НСтр("ru='Ответы на вопрос № '") + ПолныйКод + НСтр("ru=' опроса '") + НаименованиеОпроса + НСтр("ru=' от '") + Формат(ДатаОпроса,"ДФ=dd.MM.yyyy");
