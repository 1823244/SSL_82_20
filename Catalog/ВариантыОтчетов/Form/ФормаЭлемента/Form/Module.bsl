...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	БыстрыйДоступ = ПредставлениеНастроекБыстрогоДоступа(ЭтаФорма);
	Разделы       = ПредставлениеРазделов(ЭтаФорма);
...
Процедура РазделыНажатие(Элемент, СтандартнаяОбработка)
	...
	ВозвращаемыеПараметры = ОткрытьФормуМодально("Справочник.ВариантыОтчетов.Форма.НастройкаПодсистем", ПараметрыФормы, ЭтаФорма);
...
Функция ПредставлениеНастроекБыстрогоДоступа(ЭтаФорма)
	ВариантБыстрыйДоступ = ЭтаФорма.Объект.БыстрыйДоступ;
	ВариантИсключенияБыстрогоДоступа = ЭтаФорма.Объект.ИсключенияБыстрогоДоступа;
...
Функция ПредставлениеРазделов(ЭтаФорма)
	ВариантПодсистемы = ЭтаФорма.Объект.Подсистемы;
