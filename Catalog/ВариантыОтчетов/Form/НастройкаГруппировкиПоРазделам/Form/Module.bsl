...
&НаКлиенте
Процедура ДеревоПодсистемПроверкаПеретаскивания(Элемент, ПараметрыПеретаскивания, СтандартнаяОбработка, Строка, Поле)
...
Процедура СкопироватьВариант(Команда)
	...
	Результат = ОткрытьФормуМодально("Справочник.ВариантыОтчетов.Форма.СкопироватьВариантВРаздел", , ЭтаФорма);
...
Процедура ПреместитьВариант(Команда)
	...
	Результат = ОткрытьФормуМодально("Справочник.ВариантыОтчетов.Форма.ПереместитьВариантВРаздел", , ЭтаФорма);
	Если Результат <> Неопределено тогда
