...
Процедура ПроверитьПриоритет(Отказ)
	...
	Если ДополнительныеСвойства.Свойство(ОценкаПроизводительностиВызовСервераПолныеПрава.НеПроверятьПриоритет()) Или Приоритет = 0 Тогда
		Возврат;
	КонецЕсли;
	...
	Если Выборка.Следующий() Тогда
		...
		ОценкаПроизводительностиВызовСервераПолныеПрава.ЗаписатьВЖурналРегистрации(
