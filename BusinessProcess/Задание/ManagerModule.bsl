...
Функция ФормаВыполненияЗадачи(ЗадачаСсылка, ТочкаМаршрутаБизнесПроцесса) Экспорт
	...
	Если БизнесПроцессыИЗадачиПереопределяемый.ЭтоВнешняяЗадача(ЗадачаСсылка) Тогда
		Результат.Вставить("ИмяФормы", "БизнесПроцесс.Задание.Форма.ВнешнееДействие" + ТочкаМаршрутаБизнесПроцесса.Имя);
	Иначе 	
