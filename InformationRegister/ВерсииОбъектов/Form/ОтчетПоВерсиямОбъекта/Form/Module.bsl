...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе // используется переданная версия объекта
		...
		Иначе
			СформироватьОтчетПоСравнениюОбъектаСПереданнойВерсией(ТаблицаОтчета, СериализованныйXML);
		КонецЕсли;
...
Процедура СформироватьОтчетПоСравнениюОбъектаСПереданнойВерсией(ТЧОтчета, СериализованныйXML)
...
Процедура СформироватьОтчетПоВерсииОбъекта(ТЧОтчета, ИдентификаторВерсии)
	...
	Иначе
		ФормированиеПоСтандартномуМакету(ТЧОтчета,
		                                 Макет,
		                                 ПолучитьОбъектИзXML(ВерсионированиеОбъектов.ПолучитьИнформациюПоВерсии(СсылкаНаОбъект, ИдентификаторВерсии).ВерсияОбъекта),
		                                 ОписаниеВерсии);
	КонецЕсли;
...
Функция ПолучитьОписаниеПоВерсии(НомерВерсии)
	...
	ИнформацияПоВерсии = ВерсионированиеОбъектов.ПолучитьИнформациюПоВерсии(СсылкаНаОбъект, НомерВерсии);
