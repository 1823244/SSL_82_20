...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Для Каждого Запись Из ЭтотОбъект Цикл
		...
		Отказ = Не ФизическиеЛица.СерияДокументаУказанаПравильно(Запись.ВидДокумента, Запись.Серия, КлючЗаписи, "Серия") Или Отказ;
		Отказ = Не ФизическиеЛица.НомерДокументаУказанПравильно(Запись.ВидДокумента, Запись.Номер, КлючЗаписи, "Номер") Или Отказ;
	КонецЦикла;
