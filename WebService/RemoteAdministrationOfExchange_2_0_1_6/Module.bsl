...
Функция ПолучитьПланыОбменаКонфигурации()
	...
	Для Каждого ПланОбмена ИЗ Метаданные.ПланыОбмена Цикл
		...
		Если ОбменДаннымиВМоделиСервисаПовтИсп.ПланОбменаИспользуетсяВМоделиСервиса(ПланОбмена.Имя) Тогда
			
			Массив.Добавить(ПланОбмена.Имя);
			
		КонецЕсли;
		
	КонецЦикла;
	
	Возврат СтроковыеФункцииКлиентСервер.ПолучитьСтрокуИзМассиваПодстрок(Массив);
...
Функция ВыполнитьДействиеСценарияОбменаДаннымиВПервойИнформационнойБазе(ИндексСтрокиСценария, СценарийОбменаДаннымиXDTO)
	...
	Если СценарийОбменаДанными.Колонки.Найти("ИнициированоПользователем") <> Неопределено
		И СтрокаСценария.ИнициированоПользователем = Истина Тогда
