...
Функция ДоставитьСообщения(КодОтправителя, ПотокХранилище)
	...
	ОбменСообщениямиВнутренний.СериализоватьДанныеИзПотока(Отправитель, ПотокХранилище.Получить(), ЗагруженныеСообщения);
	
	// Обрабатываем очередь сообщений
	Если ОбщегоНазначения.ИнформационнаяБазаФайловая() Тогда
		
		ОбменСообщениямиВнутренний.ОбработатьОчередьСообщенийСистемы();
...
Функция ПолучитьПараметрыИнформационнойБазы(НаименованиеЭтойКонечнойТочки)
	...
	ПараметрыЭтойТочки = ОбщегоНазначения.ПолучитьЗначенияРеквизитов(ОбменСообщениямиВнутренний.ЭтотУзел(), "Код, Наименование");
